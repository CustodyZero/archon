 ...
 * No network calls are made. No Google Gemini API is contacted.
 *
 ...
 * NetworkAdapter to generativelanguage.googleapis.com, response parsing.
 *
...
export async function executeLlmInfer(
  ...
  // adapters.network to call the Google Gemini API, parse the response.
