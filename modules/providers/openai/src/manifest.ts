/**
 * Archon OpenAI Provider Module — Manifest
 *
 * Declares the OpenAI LLM provider module. This module provides the
 * llm.infer capability for inference via the OpenAI API.
 *
 ...
 */
export const OPENAI_MANIFEST: ModuleManifest = {
  module_id: 'provider.openai',
  module_name: 'OpenAI LLM Provider',
  version: '0.0.1',
  description: 'OpenAI API provider for LLM inference. Not enabled by default. Requires explicit operator enablement.',
  author: 'CustodyZero',
  license: 'Apache-2.0',
