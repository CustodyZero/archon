 ...
 * No network calls are made. No OpenAI API is contacted.
 *
 ...
 * NetworkAdapter to api.openai.com, response parsing.
 *
...
export async function executeLlmInfer(
  ...
  // adapters.network to call the OpenAI API, parse the response.
